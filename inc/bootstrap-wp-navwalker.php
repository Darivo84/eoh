...
if (! class_exists ( 'Creativespark_WP_Bootstrap_Navwalker' )) :
 ...
 */
class Creativespark_WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
	/**
			...
			*/
			...
			if ( $args->has_children && $depth === 0 ) {
				...
				$atts['href']  = ! empty( $item->url ) ? $item->url : '';
                                $atts['class'] = ( $item->menu_item_parent != 0 ) ? 'nav-link dropdown-item' : 'nav-link';
			}
